...
export class DescriptionComponent {
  ...
  makePayment(): void {
    ...
    this.http.post<{ id: string, links: { rel: string, href: string }[] }>('https://api.cartastarotecuador.com/create-order', {})
      .subscribe((response) => {
  ...
  capturePayment(token: string): void {
    this.http.get(`https://api.cartastarotecuador.com/capture-order?token=${token}`)
      .subscribe((response) => {
